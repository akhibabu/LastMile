...
describe("auto-assignment", () => {
  it("selects the nearest available agent by haversine distance", () => {
    const agents = [
      agent({ id: "far", name: "Far", currentLatitude: 26.2, currentLongitude: 91.9, currentZoneId: "a" }),
      agent({ id: "near", name: "Near", currentLatitude: 26.145, currentLongitude: 91.736, currentZoneId: "a" }),
    ];
  ...
  it("excludes unavailable, offline, and overloaded agents", () => {
    const agents = [
      agent({ id: "busy", name: "Busy", status: "BUSY", isAvailable: false, currentLatitude: 26.14, currentLongitude: 91.73 }),
      agent({ id: "off", name: "Off", status: "OFFLINE", isAvailable: false, currentLatitude: 26.14, currentLongitude: 91.73 }),
      agent({
        id: "full",
        name: "Full",
        activeOrderCount: 5,
